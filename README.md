...
``more имя_файла`` - длинные файлы с постраничной прокруткой<br>
``less имя_файла`` - длинные файлы с построчной прокруткой<br>
...
[Интерактивное обучение git](https://learngitbranching.js.org/?locale=ru_RU "git")
